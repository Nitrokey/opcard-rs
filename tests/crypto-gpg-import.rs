...
fn gpg_p384() {
    ...
    gnupg_test(
        &["9", "4", "0", temp_name, temp_email, "no comment", "", ""],
        &[
            vec![
                r"\[GNUPG:\] GET_LINE keygen.algo",
                r"\[GNUPG:\] GET_LINE keygen.curve",
            ...
            virt::gpg_inquire_pin(),
            vec![
                r"pub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}:::u:::scESC:::\+::nistp384:::0:",
                r"fpr:::::::::[0-9A-F]{40}:",
                r"grp:::::::::[0-9A-F]{40}:",
                &custom_match,
                r"sub:u:\d*:18:[0-9A-F]{16}:[0-9A-F]{10}::::::e:::\+::nistp384::",
                r"fpr:::::::::[0-9A-F]{40}:",
                r"grp:::::::::[0-9A-F]{40}:",
                r"\[GNUPG:\] KEY_CREATED B [A-F0-9]{40}",
            ],
    ...
    println!("================ FINISHED IMPORTING P384 KEYS ================");
    ...
    gnupg_test(
        ...
        &[
            vec![r"\[GNUPG:\] CARDCTRL \d D276000124010304[A-F0-9]*"],
            virt::gpg_status(virt::KeyType::P384NoAut, 1),
            vec![
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_BOOL cardedit.factory-reset.proceed",
...
fn gpg_p521() {
    ...
    gnupg_test(
        &["9", "5", "0", temp_name, temp_email, "no comment", "", ""],
        &[
            vec![
                r"\[GNUPG:\] GET_LINE keygen.algo",
                r"\[GNUPG:\] GET_LINE keygen.curve",
            ...
            virt::gpg_inquire_pin(),
            vec![
                r"pub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}:::u:::scESC:::\+::nistp521:::0:",
                r"fpr:::::::::[0-9A-F]{40}:",
                r"grp:::::::::[0-9A-F]{40}:",
                &custom_match,
                r"sub:u:\d*:18:[0-9A-F]{16}:[0-9A-F]{10}::::::e:::\+::nistp521::",
                r"fpr:::::::::[0-9A-F]{40}:",
                r"grp:::::::::[0-9A-F]{40}:",
                r"\[GNUPG:\] KEY_CREATED B [A-F0-9]{40}",
            ],
    ...
    println!("================ FINISHED IMPORTING P521 KEYS ================");
    ...
    gnupg_test(
        ...
        &[
            vec![r"\[GNUPG:\] CARDCTRL \d D276000124010304[A-F0-9]*"],
            virt::gpg_status(virt::KeyType::P521NoAut, 1),
            vec![
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_BOOL cardedit.factory-reset.proceed",
