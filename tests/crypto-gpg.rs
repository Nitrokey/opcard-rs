...
fn gpg_p384() {
    ...
    gnupg_test(
            ...
            &[
                ...
                virt::gpg_inquire_pin(),
                vec![
                    r"pub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}:::u:::scESCA:::D276000124010304[A-Z0-9]*::nistp384:::0:",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    &custom_match,
                    r"sub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}::::::a:::D276000124010304[A-Z0-9]*::nistp384::",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    r"sub:u:\d*:18:[0-9A-F]{16}:[0-9A-F]{10}::::::e:::D276000124010304[A-Z0-9]*::nistp384::",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    r"\[GNUPG:\] KEY_CREATED B [0-9A-F]{40}",
                    r"\[GNUPG:\] GET_LINE cardedit.prompt",
    ...
    println!("================ FINISHED GENERATING P384 KEYS ================");
    ...
    gnupg_test(
        ...
        .collect::<Vec<&str>>(),
        &[
            r"gpg: encrypted with nistp384 key, ID [a-fA-F0-9]{16}, created \d{4}-\d\d-\d\d",
            &custom2,
        ],
        Decrypt {
            i: encrypted_file,
    ...
    gnupg_test(
        ...
        &[
            ...
            virt::gpg_inquire_pin(),
            vec![r"\[GNUPG:\] SIG_CREATED S 19 9 00 [a-fA-F0-9]{10} [a-fA-F0-9]{40}"],
        ]
        .into_iter()
        .flatten()
        .collect::<Vec<&str>>(),
    ...
    gnupg_test(
        ...
        &[
            ...
            r"\[GNUPG:\] SIG_ID [^ ]* \d{4}-\d\d-\d\d [a-fA-F0-9]{10}",
            r"\[GNUPG:\] GOODSIG [a-fA-F0-9]{16} test name\d* \(no comment\) <test\d*@email.com>",
            r"\[GNUPG:\] VALIDSIG [a-fA-F0-9]{40} \d{4}-\d\d-\d\d [a-fA-F0-9]{10} \d \d \d 19 9 00 [a-fA-F0-9]{40}",
            r"\[GNUPG:\] TRUST_ULTIMATE 0 pgp",
        ],
        &[
            r"gpg: Signature made .*",
    ...
    gnupg_test(
        ...
        &[
            vec![r"\[GNUPG:\] CARDCTRL \d D276000124010304[A-Z0-9]*"],
            virt::gpg_status(virt::KeyType::P384, 5),
            vec![
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_BOOL cardedit.factory-reset.proceed",
...
fn gpg_p521() {
    ...
    gnupg_test(
            ...
            &[
                ...
                virt::gpg_inquire_pin(),
                vec![
                    r"pub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}:::u:::scESCA:::D276000124010304[A-Z0-9]*::nistp521:::0:",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    &custom_match,
                    r"sub:u:\d*:19:[0-9A-F]{16}:[0-9A-F]{10}::::::a:::D276000124010304[A-Z0-9]*::nistp521::",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    r"sub:u:\d*:18:[0-9A-F]{16}:[0-9A-F]{10}::::::e:::D276000124010304[A-Z0-9]*::nistp521::",
                    r"fpr:::::::::[0-9A-F]{40}:",
                    r"grp:::::::::[0-9A-F]{40}:",
                    r"\[GNUPG:\] KEY_CREATED B [0-9A-F]{40}",
                    r"\[GNUPG:\] GET_LINE cardedit.prompt",
    ...
    println!("================ FINISHED GENERATING P521 KEYS ================");
    ...
    gnupg_test(
        ...
        .collect::<Vec<&str>>(),
        &[
            r"gpg: encrypted with nistp521 key, ID [a-fA-F0-9]{16}, created \d{4}-\d\d-\d\d",
            &custom2,
        ],
        Decrypt {
            i: encrypted_file,
    ...
    gnupg_test(
        ...
        &[
            ...
            virt::gpg_inquire_pin(),
            vec![r"\[GNUPG:\] SIG_CREATED S 19 10 00 [a-fA-F0-9]{10} [a-fA-F0-9]{40}"],
        ]
        .into_iter()
        .flatten()
        .collect::<Vec<&str>>(),
    ...
    gnupg_test(
        ...
        &[
            ...
            r"\[GNUPG:\] SIG_ID [^ ]* \d{4}-\d\d-\d\d [a-fA-F0-9]{10}",
            r"\[GNUPG:\] GOODSIG [a-fA-F0-9]{16} test name\d* \(no comment\) <test\d*@email.com>",
            r"\[GNUPG:\] VALIDSIG [a-fA-F0-9]{40} \d{4}-\d\d-\d\d [a-fA-F0-9]{10} \d \d \d 19 10 00 [a-fA-F0-9]{40}",
            r"\[GNUPG:\] TRUST_ULTIMATE 0 pgp",
        ],
        &[
            r"gpg: Signature made .*",
    ...
    gnupg_test(
        ...
        &[
            vec![r"\[GNUPG:\] CARDCTRL \d D276000124010304[A-Z0-9]*"],
            virt::gpg_status(virt::KeyType::P521, 5),
            vec![
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_LINE cardedit.prompt",
                r"\[GNUPG:\] GET_BOOL cardedit.factory-reset.proceed",
